...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=1.2\linewidth, angle=90]{BespyatyyIV/images/установка матовый.jpg}
    \caption{Фото установки (одна головка и компьютер)}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{BespyatyyIV/images/установка две головки.jpg}
    \caption{Фото установки (две головки)}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\linewidth]{BespyatyyIV/images/зебра и диск.jpg}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{BespyatyyIV/images/3D модель.png}
    \includegraphics[width=0.9\linewidth]{BespyatyyIV/images/разрез 3D модель.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=\linewidth]{BespyatyyIV/images/no_trash_2500.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=\linewidth]{BespyatyyIV/images/final_reverse10_5000_head1.pdf}
...
\label{fig:profile5000_1_rev}
\end{figure}

\begin{figure}[ht!]
\centering
\includegraphics[width=\linewidth]{BespyatyyIV/images/final_reverse10_5000_head2.pdf}
...
\label{fig:profile5000_2_rev}
\end{figure}

\begin{figure}[ht!]
\centering
\includegraphics[width=\linewidth]{BespyatyyIV/images/final_reverse10_5000_avg.pdf}
